...
$(document).ready(function(){
 ...
 if (session_id() == "")
		...
		?></a></li>
             ...
             <li><a href="#"><i class="glyphicon glyphicon-user" onclick="myFunction1()"></i></a></li>
             <script>
function myFunction1() {
    window.open("friendRequest.php", "myWindow", "toolbar=yes, scrollbars=yes, resizable=yes, top=200, left=500, width=400, height=300");
}
</script>
